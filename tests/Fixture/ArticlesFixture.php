...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'addr' => ['type' => 'string', 'length' => 191, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'addr' => ['type' => 'unique', 'columns' => ['addr'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2020-04-10 21:26:07',
                'modified' => '2020-04-10 21:26:07',
                'views' => 1,
            ],
        ];
        parent::init();
